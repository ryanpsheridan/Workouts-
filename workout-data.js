const WARMUPS = {
  "full-body-upper": [ // squat maintenance + pull-up giant set + press day
    ...
    { ss: "3", ord: "3A", ex: "90/90 Lead Hip Internal Rotation Lift-Off", link: "https://www.youtube.com/watch?v=sLWSmo0uk2E", rp: "6 / side", note: "Same 90/90 position, but lift the lead-side shin off the floor and hold. Trains internal rotation strength, not just range - the impact position needs both." },
    ...
    { ss: "6", ord: "6A", ex: "Bretzles", link: "https://www.youtube.com/watch?v=rDviWORCWEw", rp: "8 / side", note: "Opens the chest and upper back before the pull-up giant set." },
    ...
    { ss: "9", ord: "9A", ex: "Lying Leg Crossover (or Supine Crossover Stretch)", rp: "30 sec / side", note: "Lying on your back, arms out in a T, cross one bent knee over the body toward the floor while keeping both shoulders pinned down. Stretches the low back, glutes, and IT band." }
  ],
  "full-body-lower": [ // hinge + unilateral legs + carry day
    ...
    { ss: "2", ord: "2A", ex: "90/90 Lead Hip Internal Rotation Lift-Off", link: "https://www.youtube.com/watch?v=sLWSmo0uk2E", rp: "6 / side", note: "90/90 seated position, lift the lead-side shin off the floor and hold. Builds internal rotation strength for the impact position before you hinge and press." },
  ...
  "lower-a": [ // prior: Upper B (pull day) -> lats, upper back, biceps, forearms
    ...
    { ss: "6", ord: "6A", ex: "Lying Leg Crossover (or Supine Crossover Stretch)", rp: "30 sec / side", note: "Lying on your back, arms out in a T, cross one bent knee over the body toward the floor while keeping both shoulders pinned down. Stretches the low back, glutes, and IT band after yesterday's pulling." }
  ],
  "upper-a": [ // today: PRESS/carries/arms. prior: Lower A -> glutes, quads, hip flexors
    ...
    { ss: "5", ord: "5A", ex: "Seated Spinal Twist (Arms Raised Overhead)", link: "https://x.com/smartpostures/status/2089006502413840469?s=46", rp: "20 reps", note: "One leg bent in front, rotate the torso, hands clasped up high. Fixes pelvic tilt and relieves back pain." },
    { ss: "6", ord: "6A", ex: "Lying Leg Crossover (or Supine Crossover Stretch)", rp: "30 sec / side", note: "Lying on your back, arms out in a T, cross one bent knee over the body toward the floor while keeping both shoulders pinned down. Stretches the low back, glutes, and IT band." }
  ],
...
const ALL_DAYS = [
  {
    ...
    phases: [
      { name: "Core Priority & Lead-Hip Power", sub: "Golf tomorrow? Skip the jumps, keep the RDL and core work light", rows: [
        ...
        { ss: "2", ord: "2A", ex: "Single-Leg Lead-Hip RDL with Rotational Drive", brace: true, rp: "3 x 6 / side", note: "Hinge on the lead leg, then drive the foot into the floor and snap the hips back to standing with a small trailing rotation - trains the push-and-turn the lead leg is missing at impact." },
        { ss: "",  ord: "2B", ex: "Half-Kneeling Cable Chop (High-to-Low)", brace: true, link: "https://www.youtube.com/watch?v=tKmTgQ_YajY", rp: "3 x 10 / side", note: "Golf downswing pattern - drive with hips and core, arms just connect." },
        { ss: "3", ord: "3A", ex: "GHD Sit-Ups", rp: "12-15", note: "Same machine as the reverse hypers - flow straight between the two." },
  ...
  },
  {
    ...
    phases: [
      { name: "Core Priority & Lead-Hip Power", sub: "Golf tomorrow? Skip the jumps, keep the RDL and core work light", rows: [
        ...
        { ss: "",  ord: "1B", ex: "Skater Bounds", link: "https://www.youtube.com/watch?v=G5tsTOqrkec", rp: "3 x 5 / side", note: "Lateral bound, stick the landing on one leg - the lead leg absorbing and redirecting force is exactly the ground-force pattern the swing needs." },
        ...
        { ss: "",  ord: "2B", ex: "Half-Kneeling Cable Chop (High-to-Low)", brace: true, link: "https://www.youtube.com/watch?v=tKmTgQ_YajY", rp: "3 x 10 / side", note: "Golf downswing pattern - drive with hips and core, arms just connect." },
        { ss: "3", ord: "3A", ex: "Hanging Leg Raise OR Captain's Chair Knee Raise", rp: "10-12", note: "Curl the knees to the chest, control the lower - no swing. Loaded lower-ab work that actually leaves you sore." },
        { ss: "",  ord: "3B", ex: "Side Plank (top leg raised)", link: "https://www.youtube.com/watch?v=PAD7sMmIgts", rp: "30-40 sec / side", note: "Anti-lean core, the other half of what the carries cover. Stack the hips, don't let them sag back." }
      ]},
      { name: "Strength & Conditioning", sub: "Superset pairs, 15-20 sec rest between exercises - keep the heart rate up without adding spinal load. Golf tomorrow? First two groups only, same weight - cut sets, never load", rows: [
