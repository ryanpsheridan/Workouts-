  ...
  },
  {
    ...
    phases: [
      ...
      { name: "Strength", sub: "Golf tomorrow? First two groups only, same weight - cut sets, never load", rows: [
        ...
        { ss: "4", ord: "4A", ex: "Glute Drive (Machine)", rp: "3 x 12-15", note: "Feet planted, drive through the heels and squeeze the glutes hard at the top - stop the rep there, don't hyperextend the low back." }
      ]},
